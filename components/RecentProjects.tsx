          ...
          >
            <PinContainer title={link} href={link}>
              ...
              <div className="flex items-center justify-between mt-7 mb-3 relative">
                ...
                {id !== 4 &&
                  id !== 3 && ( // Render only for projects other than id = 4 (electronics project...)
                    <div
                      className="flex justify-center items-center mt-3 cursor-pointer text-purple"
                ...
                {id === 3 && (
                  <div
                    className="absolute inset-0 flex flex-col justify-center items-center h-full cursor-pointer text-purple"
                    onClick={() => handleProjectClick(link)}
                  >
                    <div className="flex items-center">
                      <p>Check the GitHub Repo</p>
